                ...
                <div class="card card-rounded">
                  <div class="card-body">
                    <div class="d-sm-flex justify-content-between align-items-start">
                        <div>
                          <h4 class="card-title card-title-dash">List Admin</h4>
                        </div>
                        <div>
                        <button data-bs-toggle="modal" data-bs-target="#newAdminModal" class="btn btn-primary btn-sm text-white aksi-btn tambah-btn" type="button"><i class="mdi mdi-account-plus menu-icon"></i></button>
                        </div>
                      </div>
                      <div><h3></h3></div>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $(document).on("click", ".edit", function() {
        ...
        $("#display-admin").html("");
        $.ajax({
          url: "../../control/display/displayEditAdmin.php",
          type: "POST",
          data: {
            id: id
          },
      ...
      $(document).on("click", ".hapus", function() {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: "../../control/hapus/deleteAdmin.php",
              type: 'POST',
              data: {
                id: id
              },
        ...
        if (nama_karyawan == "" || email == "" || no_telp == "" || konfirmasi_password == "" || password == "") {
          ...
          if (password != konfirmasi_password) {
            ...
            Swal.fire({
              ...
              if (result.isConfirmed) {
                $.ajax({
                  url: '../../control/tambah/newAdmin.php',
                  type: 'POST',
                  data: $(this).serialize(),
                  cache: false,
                  success: function(data) {
